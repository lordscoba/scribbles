...
import(
	...
	helper "github.com/lordscoba/scribbles/helpers"
	"github.com/lordscoba/scribbles/models"
	"github.com/lordscoba/scribbles/database"
...
func VerifyPassword(userPassword string, providedPassword string) (bool, string){
	...
	if err != nil {
		msg = fmt.Sprintf("email of password is correct")
		check = false
	}
	return check, msg
}
